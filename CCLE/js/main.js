...
async function handleLogin(e) {
    ...
    try {
        ...
        try {
            ...
            // Si la respuesta no es JSON, probablemente no hay backend
            throw new Error('No se puede conectar al servidor. Asegúrate de que el backend está corriendo.');
        }
...
// Welcome message for CLM students - REMOVED
